...
public class Test01_11 {
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      System.out.println("更新されたコイン枚数: " + coins + "枚");
    }
    System.out.println("あなたのコイン枚数は" + coins + "枚です");

    showResults(coinCnt, win, lose, draw);
  }
  ...
  static void showResults(int[] coinCnt, int win, int lose, int draw) {
    System.out.println("showResultsメソッドが呼び出されました");
  }
